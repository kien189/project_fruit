                            ...
                            {{-- <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                                <div class="single-product position-relative">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="product-details.html">Unique content for</a>
                                            </h4>
                                        </div>
                                        <div class="price-box">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                                <div class="single-product position-relative">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="product-details.html">New and sale badge</a>
                                            </h4>
                                        </div>
                                        <div class="price-box">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                                <div class="single-product position-relative">
                                    ...
                                    <div class="product-content-listview">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="product-details.html">Countdown product</a>
                                            </h4>
                                        </div>
                                        <div class="price-box">
                                            <span class="regular-price ">$44.99</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                                <div class="single-product position-relative">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="product-details.html">Without shortcode</a>
                                            </h4>
                                        </div>
                                        <div class="price-box">
                                            <span class="regular-price ">$70.00</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                                <div class="single-product position-relative">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="product-details.html">Variable Product</a>
                                            </h4>
                                        </div>
                                        <div class="price-box">
