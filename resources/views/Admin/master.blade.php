...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('ad') }}/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('ad') }}/css/AdminLTE.css">
    <link rel="stylesheet" href="{{ asset('ad') }}/css/_all-skins.min.css">
    <link rel="stylesheet" href="{{ asset('ad') }}/css/jquery-ui.css">
    <link rel="stylesheet" href="{{ asset('ad') }}/css/style.css" />
    <script src="{{ asset('ad') }}/js/angular.min.js"></script>
    <script src="{{ asset('ad') }}/js/app.js"></script>
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{ asset('ad') }}/images/user2-160x160.jpg"
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{ asset('ad') }}/images/user2-160x160.jpg" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{{ asset('ad') }}/images/user2-160x160.jpg" class="img-circle"
                                        alt="User Image">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="{{ asset('ad') }}/images/user2-160x160.jpg" class="img-circle" alt="User Image">
                    </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('shopping.index')}}"><i class="fa fa-circle-o"></i> Quản lý đơn hàng</a></li>
    ...
    <script src="{{ asset('ad') }}/js/jquery-ui.js"></script>
    <script src="{{ asset('ad') }}/js/bootstrap.min.js"></script>
    <script src="{{ asset('ad') }}/js/adminlte.min.js"></script>
